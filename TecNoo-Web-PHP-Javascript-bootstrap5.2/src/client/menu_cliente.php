    ...
    <nav class="navbar fixed-top navbar-expand-lg bg-dark">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <p class="text-light mx-auto my-auto">Olá &nbsp; <?php echo $_SESSION['nome_cl'];?></p>
          <p class="text-success mx-auto my-auto">Cliente&nbsp;<?php echo $_SESSION['id_cli_contrato'];?></p>
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link text-light" href="lista_chamado_cliente.php">Chamados</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-light" href="#contratos">Meu Contrato</a>
            </li>
            <!-- Inicio do dropdown -->
