            ...
            <table class="table table-dark table-hover">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="largButton">
                            <a href="novo_chamado_cliente.php" class="btn largButton btn-primary btn">
                    ...
                    <?php do { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php
                                if(str_contains($row['status_chamado'], 'Aguardando')){
                                    echo ('
                                <button class="btn btn-danger largButton delete mt-2" role="button" data-nome=" '.$row['protocolo_chamado'].'" data-id="'.$row['id_chamado'].'" data-bs-toggle="modal" data-bs-target="#myModal">
